...
//            s.execute("alter table tblaccountvouchersmaxid Add  foreign key(receiptperiod_id) references tblreceiptperiod(receiptperiod_id)");
            ...
            // update on 4-08-2014 for Production
            //     s.execute("alter table tblinventorytransactionitems Add  trans_type int ");
            //s.execute("alter table tbltransactionmain Add  sg_id int ");
            //s.execute("alter table tbltransactionmain Add  FOREIGN KEY (sg_id) REFERENCES tblstockgroup (sg_id)");
...
//            /*
             ...
             // updated on 2-08-2014 for production
             ...
             // add for Production 29-07-2014
             //            s.executeQuery("drop table tblproductdefinition");
             //            s.executeQuery("drop table tblproductionitems");
             //            s.executeQuery("drop table tblproductiondetails");
             //            s.executeQuery("drop table tblproductionrawmaterial");
           
             s.execute("create table tblproductdefinition(prod_def_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) not null,primary key(prod_def_id), FinishedItem int , FOREIGN KEY (FinishedItem) REFERENCES tblstockitem (si_id), date date)");
             s.execute("create table tblproductionrawmaterial(prod_def_id int , FOREIGN KEY (prod_def_id) REFERENCES tblproductdefinition (prod_def_id), rawitem int , FOREIGN KEY (rawitem) REFERENCES tblstockitem (si_id), qty Decimal(20,2), index int , finishitemunder int , FOREIGN KEY (finishitemunder) REFERENCES tblstockgroup (sg_id) ,date date);");
             s.execute("create table tblproductiondetails(prod_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) not null,primary key(prod_id), prod_no int,date date , prod_type int);");
             s.execute("create table tblproductionitems(prod_id int ,FOREIGN KEY (prod_id) REFERENCES tblproductiondetails (prod_id) , item int, qty decimal(20,2) , type varchar(30));");
