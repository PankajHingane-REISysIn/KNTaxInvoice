...
public class EncryptionManager {
     ...
     *
     * @throws IOException if the file does not exist, or if the first byte
     ...
     *
     * @throws NoSuchAlgorithmException if the algorithm SHA1withRSA is not
     * supported.
     ...
     * implementation for SHA1withRSA.
