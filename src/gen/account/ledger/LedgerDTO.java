...
public class LedgerDTO {
    ...
    private Integer ledger_DebitOrCredit = 0;
    ...
    private String ledger_user = "";
    private String ledger_aplicable_date = "";
    private String ledger_isdeletable = "0";
    private String ledger_ECSNumber = "";
    private String ledger_CVATNumber = "";
    private String ledger_CSTNumber = "";
    ...
    public void setDebitOrCredit(Integer debitOrCredit) {
        this.ledger_DebitOrCredit = debitOrCredit;
    }
    ...
    /**
     * @param ledger_Date the ledger_Date to set
     */
    ...
    /**
     * @return the ledger_user
     */
    public String getLedger_user() {
        return ledger_user;
    }

    /**
     * @param ledger_user the ledger_user to set
     */
    public void setLedger_user(String ledger_user) {
        this.ledger_user = ledger_user;
    }

    /**
     * @return the ledger_aplicable_date
     */
    public String getLedger_aplicable_date() {
        return ledger_aplicable_date;
    }

    /**
     * @param ledger_aplicable_date the ledger_aplicable_date to set
     */
    public void setLedger_aplicable_date(String ledger_aplicable_date) {
        this.ledger_aplicable_date = ledger_aplicable_date;
    }

    /**
     * @return the ledger_isdeletable
     */
    public String getLedger_isdeletable() {
        return ledger_isdeletable;
    }

    /**
     * @param ledger_isdeletable the ledger_isdeletable to set
     */
    public void setLedger_isdeletable(String ledger_isdeletable) {
        this.ledger_isdeletable = ledger_isdeletable;
    }

    /**
     * @return the ledger_ECSNumber
     */
    public String getLedger_ECSNumber() {
        return ledger_ECSNumber;
    }

    /**
     * @param ledger_ECSNumber the ledger_ECSNumber to set
     */
    public void setLedger_ECSNumber(String ledger_ECSNumber) {
        this.ledger_ECSNumber = ledger_ECSNumber;
    }

    /**
     * @return the ledger_CVATNumber
     */
    public String getLedger_CVATNumber() {
        return ledger_CVATNumber;
    }

    /**
     * @param ledger_CVATNumber the ledger_CVATNumber to set
     */
    public void setLedger_CVATNumber(String ledger_CVATNumber) {
        this.ledger_CVATNumber = ledger_CVATNumber;
    }

    /**
     * @return the ledger_CSTNumber
     */
    public String getLedger_CSTNumber() {
        return ledger_CSTNumber;
    }

    /**
     * @param ledger_CSTNumber the ledger_CSTNumber to set
     */
    public void setLedger_CSTNumber(String ledger_CSTNumber) {
        this.ledger_CSTNumber = ledger_CSTNumber;
    }
}
