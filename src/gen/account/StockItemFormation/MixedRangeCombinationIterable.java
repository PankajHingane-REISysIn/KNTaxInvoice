 ...
 * elements, where the valid ranges may be different for each element of the
 * combination. For a set S = { S0, S1, ... Sn } there will be |S0| * |S1| * ...
 * * |Sn| possible combinations. Example:<br />
 * <pre>
 * S0 = {A,B,C}, |S0| = 3
 * S1 = {D,E}  , |S1| = 2
 * S2 = {A,E}  , |S2| = 2
...
public final class MixedRangeCombinationIterable<T> implements Iterable<List<T>> {
    ...
    /**
     * Creates an iterable over all combinations of one element of each of the
     * given sets.
     *
