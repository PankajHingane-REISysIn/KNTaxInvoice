...
public class SaleForm_NoCal extends javax.swing.JInternalFrame implements java.awt.event.ActionListener {
...
//    private Map<String, String> unitMap;
    ...
    public SaleForm_NoCal(String s, Dimension d) {
        try {
            initComponents();
            saleDTO = new SaleDTO();
            initilize();
    ...
    public SaleForm_NoCal(String s, Dimension d, SaleDTO saleDTO, Boolean isEdit) {
        try {
            initComponents();
            this.isEdit = isEdit;
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(SaleForm_NoCal.this, ex.getMessage());
        }
    }

    private void initComponents() {

        setFrameIcon(new ImageIcon(SaleForm_NoCal.class.getResource("/images/Kasturi-logo-1.png")));
...
//                } catch (Exception ex) {
//                    ex.printStackTrace();
//                    JOptionPane.showMessageDialog(SaleFormTrial.this, ex.getMessage());
//                }
//            }
//        });
//
        ...
        jTextFieldSearch.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyReleased(java.awt.event.KeyEvent evt) {
                try {
                    ...
                    JOptionPane.showMessageDialog(SaleForm_NoCal.this, ex.getMessage());
                    Logger.getLogger(SaleForm_NoCal.class.getName()).log(Level.SEVERE, null, ex);
                    ex.printStackTrace();
                }
            }
        });
    ...
    private void partiAdd() throws Exception {
        if (validateStockTransaction()) {
            ...
            if (entryCount < 15) {
                ...
                JOptionPane.showMessageDialog(SaleForm_NoCal.this, "Max 15 entries allowed per transaction");
...
//                    "[100px:100px:768px,grow,shrink 50,center]"));
            ...
            m.menuselection(4);
            SaleForm_NoCal.this.setClosed(true);
...
//                    InputStream image1 = new ByteArrayInputStream(image);
                    ...
                    parameter.put("Delivery_Type", jTextFieldNote.getText().toString().trim());
...
//        stockItemMap = gen.account.stockitem.StockItemDAO.getStockItemsFromGroupName(stockGroups, false);
    ...
    private void bindTOGUI() throws ParseException, SQLException, Exception {
        ...
        System.out.println("Get Count ----------- --- " + gen.accountvoucher.chalan.ChalanDAO.getCount_transaction(Constants.SALE_TYPE_INDEX, Constants.CREDIT));
        System.out.println("Get Count ----------- Number --- " + number);
        ...
        System.out.println("Get Count ----------- remaining --- " + remaining);
...
//        }
    ...
    private void calculateAndBindExciseDutyRate() throws Exception {
        ...
        if (vatRate != 0) {
            ...
            jtextField_ExDutyAmt.setText("" + Constants.DECIMAL_FORMAT.format(vatAmount));
        }
    ...
    private void calculateAndBind_EdCessRate() throws Exception {
        ...
        if (vatRate != 0) {
            ...
            vatAmount = basicAmount * (vatRate / 100);
            jtextField_EdCessAmt.setText("" + Constants.DECIMAL_FORMAT.format(vatAmount));
        }
    ...
    private void calculateAndBind_H_EdCessRate() throws Exception {
        ...
        if (vatRate != 0) {
            ...
            vatAmount = basicAmount * (vatRate / 100);
            jtextField_H_EdCessAmt.setText("" + Constants.DECIMAL_FORMAT.format(vatAmount));
        }
...
//            } catch (SQLException ex) {
//                Logger.getLogger(SaleFormTrial.class.getName()).log(Level.SEVERE, null, ex);
//            }
//        }
//    }
    private void setStockItemProperties() throws Exception {
...
//                    }
    ...
    public class MessageBox {
        ...
        String filechoose() {
            ...
            int r = chooser.showSaveDialog(SaleForm_NoCal.this);
    ...
    private void dataExport() {
        ...
        path = "";
        SaleForm_NoCal.MessageBox msgBox = new SaleForm_NoCal.MessageBox();
