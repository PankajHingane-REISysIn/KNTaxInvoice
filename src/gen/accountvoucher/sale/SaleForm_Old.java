...
public class SaleForm_Old extends javax.swing.JInternalFrame implements java.awt.event.ActionListener {
...
//    private Map<String, String> unitMap;
    ...
    public SaleForm_Old(String s, Dimension d) {
        try {
            initComponents();
            saleDTO = new SaleDTO();
            initilize();
    ...
    public SaleForm_Old(String s, Dimension d, SaleDTO saleDTO, Boolean isEdit) {
        try {
            initComponents();
            this.isEdit = isEdit;
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(SaleForm_Old.this, ex.getMessage());
        }
    }

    private void initComponents() {

        setFrameIcon(new ImageIcon(SaleForm_Old.class.getResource("/images/Kasturi-logo-1.png")));
        ...
        jTextFieldSearch.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyReleased(java.awt.event.KeyEvent evt) {
                try {
                    ...
                    JOptionPane.showMessageDialog(SaleForm_Old.this, ex.getMessage());
                    Logger.getLogger(SaleForm_Old.class.getName()).log(Level.SEVERE, null, ex);
                    ex.printStackTrace();
                }
            }
        });
    ...
    private void partiAdd() throws Exception {
        if (validateStockTransaction()) {
            ...
            if (entryCount < 15) {
                ...
                JOptionPane.showMessageDialog(SaleForm_Old.this, "Max 15 entries allowed per transaction");
...
//                    "[100px:100px:768px,grow,shrink 50,center]"));
            ...
            m.menuselection(4);
            SaleForm_Old.this.setClosed(true);
...
//        }
        ...
        jtextField_Total_WithoutVAT.setText(Constants.DECIMAL_FORMAT.format( Math.round(finalAmount) ) + "");
    }
...
//                    }
    ...
    public class MessageBox {
        ...
        String filechoose() {
            ...
            int r = chooser.showSaveDialog(SaleForm_Old.this);
    ...
    private void dataExport() {
        ...
        path = "";
        SaleForm_Old.MessageBox msgBox = new SaleForm_Old.MessageBox();
