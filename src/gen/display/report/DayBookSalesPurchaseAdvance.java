...
public class DayBookSalesPurchaseAdvance extends javax.swing.JInternalFrame {
    ...
    String date = "", printtime = "";
    private final JTextField tfDatePicker, tfDatePicker1;
    private boolean hide_flag = false;

    public DayBookSalesPurchaseAdvance(String s) {
        setClosable(true);
        initComponents();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////        
    ...
    private void initComponents() {
        ...
        tableCredit.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sr.No","Particulars","VCH No","Amount","Weight"
            }
        ));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelDebitLayout.createSequentialGroup()
                .addGroup(panelDebitLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelDebitLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(labelTotalCreditWeight, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(panelDebitLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jScrollPane2)))
                .addGap(18, 18, 18)
                .addGroup(panelDebitLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(panelDebitLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(labelTotalDebitWeight, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        combine.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sr.No","Particulars","VCH No","Amount","Weight","`Sr.No","`Particulars","`VCH No","`Amount","`Weight"
            }
        ));
                    ...
                    .addGroup(panelMainLayout.createSequentialGroup()
                        ...
                        .addGroup(panelMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelMainLayout.createSequentialGroup()
                                ...
                                .addGap(32, 32, 32)
                                .addComponent(dat2, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(43, 43, 43)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(scrollpaneMain, javax.swing.GroupLayout.DEFAULT_SIZE, 581, Short.MAX_VALUE)
        );
    ...
    private void tableCreditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableCreditMouseClicked
        ...
        if (tableCredit.getValueAt(row, 1) != null && tableCredit.getValueAt(row, 3) != null) {
            ...
            //            Logger.getLogger(DayBookSalesPurchaseAdvance.class.getName()).log(Level.SEVERE, null, ex);
            //        }
            catch (Exception ex) {
                Logger.getLogger(DayBookSalesPurchaseAdvance.class.getName()).log(Level.SEVERE, null, ex);
            }
...
//            }
        ...
        for (int i = 0; i < totalRowCount; i++) {
            ...
            if (i < tableDebit.getRowCount()) {
                ...
                for (int j = 0; j < tableDebit.getColumnCount(); j++) {
                    ...
                    System.out.println("DDDIIIIIIIIIIIIIIIIIII" + i);
                    System.out.println("DDDJJJJJJJJJJJJJJJJJJJ" + j);
    ...
    public void showreport() {
        System.out.println("labeldfsdfsd         labelTotalCreditWeight");
        if (dat1.getDate() == null) {
            ...
            labelTotalCredit.setText("" + (total_sales));
    ...
    private void calculateTotalCreditWeight() {
        ...
        System.out.println("labeldfsdfsd         labelTotalCreditWeight" + weight);
    ...
    private void calculateTotalDebitWeight() {
        ...
        System.out.println("labeldfsdfsd         labelTotalDebitWeight" + weight);
