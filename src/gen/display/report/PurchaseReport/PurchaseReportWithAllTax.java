...
public class PurchaseReportWithAllTax extends JInternalFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    gen.display.report.PurchaseReport.PurchaseReportWithAllTax frame = new gen.display.report.PurchaseReport.PurchaseReportWithAllTax();
     ...
     * Create the frame.
     */
    public PurchaseReportWithAllTax() {
        ...
        addInternalFrameListener(new InternalFrameAdapter() {
            ...
            public void internalFrameOpened(InternalFrameEvent arg0) {
                try {
                    ...
                    ex.printStackTrace();
                    JOptionPane.showMessageDialog(gen.display.report.PurchaseReport.PurchaseReportWithAllTax.this, ex.getMessage());
                }
...
//        buttonExport.setEnabled(false);
        ...
        buttonExport.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    e1.printStackTrace();
                    JOptionPane.showMessageDialog(gen.display.report.PurchaseReport.PurchaseReportWithAllTax.this, "Export Failure");
                }
        ...
        tableCredit.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent arg0) {
                ...
                if (tableCredit.getValueAt(row, 1) != null && tableCredit.getValueAt(row, 3) != null) {
                    try {
                        String id = tableCredit.getValueAt(tableCredit.getSelectedRow(), 3).toString();
                        PurchaseDTO purchaseDTO = new PurchaseDTO();
                        TaxInvoicePurchaseForm p = new TaxInvoicePurchaseForm(purchaseDTO, true);
                        p.loadEditForm(id);
                        p.pack();
        ...
        tableCredit.setModel(new DefaultTableModel(
                ...
                new String[]{
                    "Date", "Particulars", "Reference", "VCH No", "Quantity", "Amount", "Ex Amt", "Ed Amt", "H_Ed Amt", "VAT Amount", "CST Amt", "Final Amount"
                }));
    ...
    private void dataExport() throws Exception {
        path = "";
        gen.display.report.PurchaseReport.PurchaseReportWithAllTax.MessageBox msgBox = new gen.display.report.PurchaseReport.PurchaseReportWithAllTax.MessageBox();
        if (path != null) {
            if (!path.isEmpty()) {
                try {
                    // TODO add your handling code here:
                    TagsHelper1.generatePurchaseReportExcel("Purchase", advanceSaleReportDTOWithFinalValue, path, tfDatePicker.getText().trim(), tfDatePicker1.getText().trim());
                    JOptionPane.showMessageDialog(this, "Export Successful");
                } catch (Exception ex) {
                    Logger.getLogger(PurchaseReportWithAllTax.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public class MessageBox {
        ...
        String filechoose() {
            ...
            int r = chooser.showSaveDialog(gen.display.report.PurchaseReport.PurchaseReportWithAllTax.this);
    ...
    public void loadPurchaseEntry() throws Exception {
        ...
        try {
            ...
            q = "select trans_ledgerId,trans_amt,trans_id from tbltransactionledger where trans_type=" + gen.dto.Constants.DEBIT + " and trans_id in(select trans_id from tbltransactionmain where trans_date BETWEEN '"
                    + date1
                    + "' AND '"
                    + date2
            ...
            while (rs2.next()) {
                ...
                if (rs3.next()) {
                    ...
                    if (rs5.next()) {
                        ...
                        if (rs5.getString("trans_reference") == null) {
                            ...
                            if (rs5.getString("trans_reference")
                                ...
                                tableCredit.setValueAt(rs5.getString("trans_reference"), row, 2);
                            }
                        }
                    }
                    advanceSaleReportDTO.setPurchase_Reference(tableCredit.getValueAt(row, 2).toString());
                    ...
                    if (rs4.next()) {
                        ...
                        tableCredit.setValueAt(rs4.getLong("trans_receiptNo"), row, 3);
                    ...
                    // Debitted Amount
                    tableCredit.setValueAt(Constants.DECIMAL_FORMAT.format(rs2.getDouble("trans_amt")), row, 11);
                    ...
                    if (rs4.next()) {
                        ...
                        // row, 2);
                        tableCredit.setValueAt(Constants.DECIMAL_FORMAT.format(rs4.getDouble("totalQty")), row, 4);
...
//                                    tableCredit.setValueAt(Constants.DECIMAL_FORMAT.format(rs4.getDouble("vat_rate")), row, 13);
                        ...
                        tableCredit.setValueAt(Constants.DECIMAL_FORMAT.format(rs4.getDouble("trans_amt")), row, 5);
            ...
            if (tableCredit.getRowCount() > 0) {
                ...
                while (i < tableCredit.getRowCount()) {
                    if (tableCredit.getValueAt(i, 4) != null) {
                        qty = qty + Double.parseDouble(tableCredit.getValueAt(i, 4).toString());
                    }
                    i++;
                }
                total_sales = qty;
                ...
                i = 0;
                while (i < tableCredit.getRowCount()) {
                    if (tableCredit.getValueAt(i, 5) != null) {
                        basicAmount = basicAmount + Double.parseDouble(tableCredit.getValueAt(i, 5).toString());
                    }
                    i++;
                }
...
//                    }
                ...
                i = 0;
                while (i < tableCredit.getRowCount()) {
                    if (tableCredit.getValueAt(i, 11) != null) {
                        finalAmount = finalAmount + Double.parseDouble(tableCredit.getValueAt(i, 11).toString());
                    }
                    i++;
                }
            ...
            tableCredit.setValueAt("Total", rowCount, 3);
            tableCredit.setValueAt(Constants.DECIMAL_FORMAT.format(qty), rowCount, 4);
            tableCredit.setValueAt(Constants.DECIMAL_FORMAT.format(basicAmount), rowCount, 5);
            tableCredit.setValueAt(Constants.DECIMAL_FORMAT.format(total_VAT_Amount), rowCount, 9);
            tableCredit.setValueAt(Constants.DECIMAL_FORMAT.format(total_Ex_Amount), rowCount, 6);
            tableCredit.setValueAt(Constants.DECIMAL_FORMAT.format(total_Ed_Amount), rowCount, 7);
            tableCredit.setValueAt(Constants.DECIMAL_FORMAT.format(total_H_Ed_Amount), rowCount, 8);
            tableCredit.setValueAt(Constants.DECIMAL_FORMAT.format(total_CST_Amount), rowCount, 10);
            tableCredit.setValueAt(Constants.DECIMAL_FORMAT.format(finalAmount), rowCount, 11);
...
//        passedTable.getColumnModel().getColumn(4).setMaxWidth(120);
        ...
        tableCredit.getColumnModel().getColumn(3).setPreferredWidth(50);
        tableCredit.getColumnModel().getColumn(3).setMaxWidth(50);
        tableCredit.getColumnModel().getColumn(4).setMaxWidth(75);
        tableCredit.getColumnModel().getColumn(5).setPreferredWidth(140);
        tableCredit.getColumnModel().getColumn(5).setMaxWidth(140);
        tableCredit.getColumnModel().getColumn(6).setMaxWidth(80);
        tableCredit.getColumnModel().getColumn(7).setPreferredWidth(80);
        tableCredit.getColumnModel().getColumn(7).setMaxWidth(80);
        tableCredit.getColumnModel().getColumn(8).setPreferredWidth(80);
        tableCredit.getColumnModel().getColumn(8).setMaxWidth(80);
        tableCredit.getColumnModel().getColumn(9).setPreferredWidth(100);
        tableCredit.getColumnModel().getColumn(9).setMaxWidth(100);
        tableCredit.getColumnModel().getColumn(10).setPreferredWidth(100);
        tableCredit.getColumnModel().getColumn(10).setMaxWidth(100);
        tableCredit.getColumnModel().getColumn(11).setPreferredWidth(150);
        tableCredit.getColumnModel().getColumn(11).setMaxWidth(150);
