...
public class CashDayBook extends javax.swing.JInternalFrame {
...
//                String dateStr = Util.formatDatePickerText(tfDatePicker.getText());
//                if(dateStr != null){
//                    tfDatePicker.setText(dateStr);
//                }
            }
    ...
    private void initComponents() {
        ...
        setTitle(org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.title")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.jLabel1.text")); // NOI18N

        dat.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N

        btnShow.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(btnShow, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.btnShow.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(btnPrint, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.btnPrint.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(btnBack, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.btnBack.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel7, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.jLabel7.text")); // NOI18N

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(jLabel6, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.jLabel6.text")); // NOI18N

        jLabel2.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.jLabel2.text")); // NOI18N

        jLabel3.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(jLabel3, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.jLabel3.text")); // NOI18N

        labelTotalCredit.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(labelTotalCredit, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.labelTotalCredit.text")); // NOI18N

        labelTotalDebit.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(labelTotalDebit, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.labelTotalDebit.text")); // NOI18N
        ...
        panelDebitLayout.setHorizontalGroup(
            ...
            .addGroup(panelDebitLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(labelTotalDebit, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(41, 41, 41))
        );
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel5, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.jLabel5.text")); // NOI18N

        labelOpeningBalance.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(labelOpeningBalance, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.labelOpeningBalance.text")); // NOI18N

        jLabel8.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(jLabel8, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.jLabel8.text")); // NOI18N

        labelClosingBalance.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(labelClosingBalance, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.labelClosingBalance.text")); // NOI18N

        labelCType.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(labelCType, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.labelCType.text")); // NOI18N

        labelOType.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(labelOType, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.labelOType.text")); // NOI18N
                ...
                .addGroup(panelMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelMainLayout.createSequentialGroup()
                        ...
                        .addGroup(panelMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(labelOType, javax.swing.GroupLayout.DEFAULT_SIZE, 310, Short.MAX_VALUE))))
                .addGap(415, 415, 415))
            .addGroup(panelMainLayout.createSequentialGroup()
                .addGroup(panelMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelMainLayout.createSequentialGroup()
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel4, org.openide.util.NbBundle.getMessage(CashDayBook.class, "CashDayBook.jLabel4.text")); // NOI18N
    ...
    private void btnShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowActionPerformed
        ...
        if (dat.getDate() == null) {
            ...
            labelTotalCredit.setText("" + Constants.DECIMAL_FORMAT.format(total_sales + total_receipt));

            loadPurchaseEntry();
            loadPaymentEntry();

            labelTotalDebit.setText("" + Constants.DECIMAL_FORMAT.format(total_purchase + total_payment));
...
//                q = "select sum(trans_amt) as totalDeb from tbltransactionledger where trans_type=1 and trans_id in (select trans_id from tbltransactionmain where trans_date<'" + dateNow + "' and trans_typeIndex=2) and trans_ledgerid in(select ledger_id from tblledger where ledger_under in('" + group_under_id + "'))";
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        PrintAllReport.printTableCashDaybookDemo(parameter, new JRTableModelDataSource(combine.getModel()));
    ...
    private void tableCreditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableCreditMouseClicked
        ...
        if (tableCredit.getValueAt(row, 1) != null && tableCredit.getValueAt(row, 3) != null) {
            ...
            try {
                ...
                Logger.getLogger(CashDayBook.class.getName()).log(Level.SEVERE, null, ex);
            } 
        }
...
//                   }
    ...
    private void setColumnWidth(JTable passedTable) {
        ...
        passedTable.getColumnModel().getColumn(1).setMinWidth(120);
        passedTable.getColumnModel().getColumn(1).setMaxWidth(120);


        passedTable.getColumnModel().getColumn(2).setPreferredWidth(0);
        passedTable.getColumnModel().getColumn(2).setMinWidth(30);
        passedTable.getColumnModel().getColumn(2).setMaxWidth(30);

        passedTable.getColumnModel().getColumn(3).setPreferredWidth(0);
        passedTable.getColumnModel().getColumn(3).setMinWidth(110);
        passedTable.getColumnModel().getColumn(3).setMaxWidth(110);
        ...
        passedTable.getColumnModel().getColumn(5).setMinWidth(40);
        passedTable.getColumnModel().getColumn(5).setMaxWidth(40);
    }
