...
public class PrelanBoardProductionDTO {
    ...
    private String prelanBoard_group_id = "3";
     ...
     */
    public String getPrelanBoard_id() {
        return prelanBoard_group_id;
    }

    /**
     * @param resin_group_id the resin_group_id to set
     */
    public void set_PrelanBoard_group_id(String Prelan_Board_group_id) {
        this.prelanBoard_group_id = Prelan_Board_group_id;
    }
